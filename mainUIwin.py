...
class MainUI(object):
    ...
    def create_widgets(self):
        ...
        f_btn.place(x=0, y=208, width=350, height=45)  # 设置框架的大小，及在top窗口显示位置
        submit_button = tkinter.Button(f_btn, text="提交", command=self.get_value, width=36, height=3,bg='green')  # 设置按钮的文字，调用方法，大小，颜色，显示框架
